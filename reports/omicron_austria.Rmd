...
Estimates of the vaccine effectiveness against the Omicron variant are based upon the 
results of the UKHSA test negative case control study. [@ukhealthsecurityagencyOmicronVOC21NOV015292021]
A logistic regression is fitted to the vaccine effectiveness study estimaes, as shown in figure \@ref(fig:assumed-ve).
...
A logit model based waning of vaccine effectivness over time is assumed. 

```{r, assumed-ve, warning=FALSE, message=FALSE, out.width = '75%', fig.width=8, fig.height=4, fig.align = 'center', dpi=150, fig.cap="", dev="png", fig.cap="Assumed immunity to the Omicron variant"}
