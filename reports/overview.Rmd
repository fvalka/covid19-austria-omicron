...
data %>%
  ...
  rename("Date, week ending"=Kalenderwoche,
         ...
         "All cases"=cases_all,
         "Proportion cases assigned to VOC"=proportion_assigned) %>%
...
```{r epidemia-multiplicative-advantage, warning=FALSE, out.width = '100%', fig.width=10, fig.height=4.6, dpi=150, fig.cap="Posterior of the multiplicative advantage in the effective reproduction number of Omicron over Delta, assuming equal generation time distributions. B and C, Comparison of the effective Reproduction Numbers 10 days before the last day of reported VOC cases", dev="png", message=FALSE}
